...
<html>
<head>
<title>Chatter Box - Help Chat</title>
...
<div id="wrapper">
        ...
        <div id="chatbox"><?php
        if (file_exists ( "../logs/helpchat.html" ) && filesize ( "../logs/helpchat.html" ) > 0) {
            $handle = fopen ( "../logs/helpchat.html", "r" );
            $contents = fread ( $handle, filesize ( "../logs/helpchat.html" ) );
            fclose ( $handle );
...
$("#submitmsg").click(function(){
        ...
        {
          $.post("../postFunctions/posthelp.php", {text: clientmsg});
          $("#usermsg").attr("value", "");
          loadLog;
        }
        else
