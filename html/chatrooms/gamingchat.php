...
<html>
<head>
<title>Chatter Box - Gaming Chat</title>
<link type="text/css" rel="stylesheet" href="../style.css" />
</head>
<body>
    <h1>GAMING CHATROOM</h1>
...
<div id="wrapper">
        ...
        <div id="chatbox"><?php
        if (file_exists ( "../logs/gamingchat.html" ) && filesize ( "../logs/gamingchat.html" ) > 0) {
            $handle = fopen ( "../logs/gamingchat.html", "r" );
            $contents = fread ( $handle, filesize ( "../logs/gamingchat.html" ) );
            fclose ( $handle );
...
$("#submitmsg").click(function(){
        ...
        {
          $.post("../postFunctions/postgaming.php", {text: clientmsg});
          $("#usermsg").attr("value", "");
          loadLog;
        }
        else
...
<a href="randomchat.php">Random Chat Room</a>
</body>
</html>
